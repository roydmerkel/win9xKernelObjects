...
// WIN98_K32OBJ_*, WINME_K32OBJ_* - António Feijão - Remote Library
// FILE: TIB.H 
//================================== 
...
#define WINME_K32OBJ_CHANGE               0x5
#define WINME_K32OBJ_PROCESS              0x6
#define WINME_K32OBJ_THREAD               0x7
#define WINME_K32OBJ_FILE                 0x8
#define WINME_K32OBJ_CONSOLE              0x9
#define WINME_K32OBJ_SCREEN_BUFFER        0xA
#define WINME_K32OBJ_MAILSLOT             0xB
#define WINME_K32OBJ_SERIAL               0xC
#define WINME_K32OBJ_MEM_MAPPED_FILE      0xD
#define WINME_K32OBJ_PIPE                 0xE
#define WINME_K32OBJ_DEVICE_IOCTL         0xF
#define WINME_K32OBJ_TOOLHELP_SNAPSHOT    0x10
#define WINME_K32OBJ_SOCKET               0x11
#endif